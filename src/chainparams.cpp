...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 31680; 
        consensus.SegwitHeight = 31680; 
        consensus.MinBIP9WarningHeight = 31680; // segwit activation height + miner confirmation window
...
public:
    CTestNetParams() {
        ...
        // Deployment of Taproot (BIPs 340-342)
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartHeight = 20000; // March 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeoutHeight = 30000; // 364 days later

        // Deployment of MWEB (LIP-0002, LIP-0003, and LIP-0004)
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartHeight = 20000; // Jan/Feb 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nTimeoutHeight = 30000; // 364 days later

        consensus.nMinimumChainWork = uint256S("0x00");
        consensus.defaultAssumeValid = uint256S("0x3d490e4ba9fcdd49d7c69ae44f509e3f2afa39499035264d5f65bf2c12705370"); // 1737876
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].bit = 4;
        consensus.vDeployments[Consensus::DEPLOYMENT_MWEB].nStartTime = 10000; 
