...
const char * const BITCOIN_CONF_FILENAME = "Hours.conf";
const char * const BITCOIN_PID_FILENAME = "Hours.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hours";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Hours";
#else
    // Unix
    return pathRet / ".Hours";
#endif
#endif
}
