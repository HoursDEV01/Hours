...
#if defined(NDEBUG)
# error "Hours cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Hours Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s HOURS additional fees, %d delta bytes\n",
