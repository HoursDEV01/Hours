...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hours-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hours-tx [options] <hex-tx> [commands]  Update hex-encoded hours transaction\n" +
            "or:     hours-tx [options] -create [commands]   Create hex-encoded hours transaction\n" +
            "\n";
