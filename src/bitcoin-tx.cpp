...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s Hours-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  Hours-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Hours transaction") + "\n" +
              "  Hours-tx [options] -create [commands]   " + _("Create hex-encoded Hours transaction") + "\n" +
              "\n";
