...
regularly from release branches to indicate new official, stable release versions of Hours Core.

The https://github.com/hours-project/gui repository is used exclusively for the
