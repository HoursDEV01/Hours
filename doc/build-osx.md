...
1. Clone the Hours Core source code:
    ```shell
...
2.  Build Hours Core:
    ...
    Configure and build the headless Hours Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Hours Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Hours"

touch "/Users/${USER}/Library/Application Support/Hours/hours.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Hours/hours.conf"
```

The first time you run hoursd, it will start downloading the blockchain. This process could
