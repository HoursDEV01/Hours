# Support for Output Descriptors in Hours Core

Since Hours Core v0.17, there is support for Output Descriptors. This is a
...
existing Hours Core wallets, a convenience function `combo` is
