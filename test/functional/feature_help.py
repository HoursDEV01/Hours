...
"""Verify that starting hours with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hours with -h for help text")
        ...
        self.log.info("Start hours with -version for version information")
        ...
        self.log.info("Start hoursd with -fakearg to make sure it does not start")
