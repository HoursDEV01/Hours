Contributing to Hours Core
============================

The Hours Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Hours Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/hours-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to hours-qt
...
The following applies to code changes to the Hours Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Hours
Network Protocol consensus changes.

Whether a pull request is merged into Hours Core rests with the project merge
...
Patches that change Hours consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hours consensus, it must have been
...
The project leader is the release manager for each Hours Core release.
